...
def main():
    ...
    train_dataset = CIFAR100(train=True, download=True, root='./data', transform=transform)
    test_dataset = CIFAR100(train=False, download=True, root='./data', transform=transform)
